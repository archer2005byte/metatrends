  ...
  return (
    <main className="site-shell" onClick={handleCanvasClick}>
      ...
      <section className="cover panel panel-lime" id="cover">
        ...
        <header className="topbar cover-topbar"><span className="eyebrow dark-eyebrow">EY Managers // 2026</span><span className="page-index">00—11</span></header>
      ...
      <section className="navigator panel panel-dark" id="navigator">
        <div className="section-head navigator-head"><p className="section-no">10 / THE FUTURE OPERATING ENVIRONMENT</p><h2>The operating system<br /><span>is changing.</span></h2><p className="navigator-subhead">Six forces. One system.</p></div>
      ...
      <section className={`hero panel panel-dark bostrom-stage-${bostromStage}`} id="top">
        ...
        <header className="topbar"><span className="eyebrow">EY Managers // 2026</span><span className="page-index">01—12</span></header>
      ...
      <section className={`panel panel-dark crowd-panel crowd-stage-${crowdStage}`} id="crowd">
        ...
        <div className="crowd-metrics">
          ...
          <div className="crowd-metric metric-messages"><b>70,000+</b><span>MESSAGES</span></div>
        </div>
        <aside className="crowd-case" aria-live="polite">
          ...
          <p>In a large-scale agent evaluation, agents used shared infrastructure to communicate, propagated discoveries across the population, and later participated in the Hugging Face intrusion. The episode showed what becomes possible when machine cognition is cheap enough to deploy in crowds.</p>
      ...
      <section className={`panel energy-panel energy-stage-${energyStage} ${energyStage === 1 ? "energy-planetary-open" : ""} ${energyStage === 2 ? "energy-dyson-open" : ""}`} id="energy"><div className="section-head"><p className="section-no">05 / THE BINDING CONSTRAINT</p><h2>Intelligence scales.<br /><span>Energy decides.</span></h2></div><div className="energy-layout"><div className="energy-bars" aria-label="Increasing energy demand illustration">{[22, 28, 35, 46, 61, 78, 94].map((height, index) => <div className="energy-bar-wrap" key={height}><div className="energy-bar" style={{height: `${height}%`}} /><small>{2019 + index}</small></div>)}<div className="bar-axis-label">data centres / compute / cooling / grid</div></div><div className="energy-ideas"><div className="idea"><b>NOW</b><span>Grid constraints</span></div><div className="idea"><b>NEXT</b><span>Nuclear as bridge</span></div><div className="idea future"><b>THEN</b><span>Planetary energy systems</span></div></div></div><div className="planetary-overlay" aria-live="polite">
